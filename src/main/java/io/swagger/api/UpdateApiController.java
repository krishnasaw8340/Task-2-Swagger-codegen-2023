...
public class UpdateApiController implements UpdateApi {
    ...
    public ResponseEntity<Void> updateIdPut(@ApiParam(value = "ID of the data to update",required=true) @PathVariable("id") Integer id,@ApiParam(value = "Updated data" ,required=true )  @Valid @RequestBody Mdata data) {
